...
public class UserService {
    ...
    public List<UserDTO> list() {
        List<User> users = userDAO.findAllnotNull();
...
//        List<AdminRole> allRoles = adminRoleService.findAll();
    ...
    public User resetPassword1(String username,String newpassword) {
    ...
    public void admin_editUser(User user) {
        User userInDB = userDAO.findByUsername(user.getUsername());
...
//        List<AuditInfo> userinfos=auditInfoDAO.findbyUid(id);
        userDAO.deleteByIdunlessNameZH(id);
    }
...
//
//    public Object matchs(User user,String oldWord) {
////        User user = ShiroUtil.getUser();
//        boolean result = user.getPassword().equals(encryptPassword(oldWord,user.getSalt()));
//        if ( true == result){
//            return Constant.MATCH_FIT;
//        }else
