<template>
  <div class="articles-area">
        ...
        <el-form v-model="article" label-width="100px" label-position="left" size="mini">
          <el-form-item label="审核意见" prop="desc">
            ...
            <el-input type="textarea" v-model="article.articleAuditMind" autosize
                      :disabled="article.audit_status.id==3||article.audit_status.id==8 ? false : true"></el-input>
          </el-form-item>
        </el-form>
      </div>
    </el-card>
    ...
    <div style="margin-left:-800px;margin-top:40px;margin-bottom:30px">
      <el-button style="left: 10px" type="primary" v-if="article.audit_status.id == 3 || article.audit_status.id == 8"
                 @click="saveAuditArticles(4,'终审通过')">终审通过</el-button>
      <el-button style="left: 100px;" type="danger" v-if="article.audit_status.id == 3 || article.audit_status.id == 8"
                 @click="saveAuditArticles(8,'不通过')">不通过</el-button>
    </div>
